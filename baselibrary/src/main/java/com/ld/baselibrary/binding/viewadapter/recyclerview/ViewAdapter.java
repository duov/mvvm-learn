...
import com.ld.baselibrary.binding.command.BindingCommand;
...
public class ViewAdapter {
    ...
    public static <T> void setAdapter(RecyclerView recyclerView, ItemBinding<T> itemBinding, List<T> items, BaseBindingRecyclerViewAdapter<T> adapter, BaseBindingRecyclerViewAdapter.ItemIds<? super T> itemIds, BaseBindingRecyclerViewAdapter.ViewHolderFactory viewHolderFactory) {
        if (itemBinding == null) {
            throw new IllegalArgumentException("itemBinding must not be null");
        }
        BaseBindingRecyclerViewAdapter oldAdapter = (BaseBindingRecyclerViewAdapter) recyclerView.getAdapter();
        if (adapter == null) {
            if (oldAdapter == null) {
                adapter = new BaseBindingRecyclerViewAdapter<>();
            } else {
                adapter = oldAdapter;
            }
        }
